...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.mask = Variable(torch.ones(3, 224, 224), requires_grad=True)
...
def mask_ResNet(version=26, herit=False, num_classes=10):
    if version == 41:
        child_net = ResNet(Bottleneck, [(0, False), (4, True), (5, True), (3, True)], num_classes=num_classes)
    elif version == 32:
        child_net = ResNet(Bottleneck, [(1, False), (4, True), (4, True), (1, True)], num_classes=num_classes)
    elif version == 26:
        child_net = ResNet(Bottleneck, [(0, False), (2, False), (5, False), (1, True)], num_classes=num_classes)
    elif version == 50:
        child_net = ResNet(Bottleneck, [(3, True), (4, True), (6, True), (3, True)], num_classes=num_classes)
    else:
...
def main():
    # net = ResNet(Bottleneck, [(0, False), (4, True), (5, True), (3, True)], num_classes=10)  # ResNet-41
    # net = ResNet(Bottleneck, [(1, False), (4, True), (4, True), (1, True)], num_classes=10)  # ResNet-32 x
    # net = ResNet(Bottleneck, [(0, False), (2, False), (5, False), (1, True)], num_classes=10)   # ResNet-26 x
    net = mask_ResNet(50, True, 10)
